...
class RideDetailModel {
  ...
  factory RideDetailModel.fromJson(Map<String, dynamic> json) {
    return RideDetailModel(
      ...
      driverRatting: json['driver_rating'] != null ? DriverRattingClient.fromJson(json['driver_rating']) : null,
      riderRatting: json['rider_rating'] != null ? DriverRattingClient.fromJson(json['rider_rating']) : null,
