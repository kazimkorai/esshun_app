...
InputDecoration inputDecoration(BuildContext context, {String? label, Widget? prefixIcon, Widget? suffixIcon}) {
  return InputDecoration(
    ...
    border: OutlineInputBorder(borderRadius: BorderRadius.circular(defaultRadius), borderSide: BorderSide(color: primaryColorD.withOpacity(0.1))),
    focusedErrorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(defaultRadius), borderSide: BorderSide(color: primaryColorD.withOpacity(0.1))),
    disabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(defaultRadius), borderSide: BorderSide(color: primaryColorD.withOpacity(0.1))),
    focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(defaultRadius), borderSide: BorderSide(color: primaryColorD.withOpacity(0.1))),
    enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(defaultRadius), borderSide: BorderSide(color: primaryColorD.withOpacity(0.1))),
  ...
  return Container(
    ...
    decoration: BoxDecoration(
      border: Border.all(
          color: isSelected
              ? primaryColorD
              : appStoreClient.isDarkMode
              ? Colors.transparent
              : borderColor),
    ),
    child: Row(
      children: [
        ImageIcon(AssetImage(imagePath), size: 20, color: isSelected ? primaryColorD : Colors.grey),
        SizedBox(width: 16),
...
bool get isRTL => rtlLanguage.contains(appStoreClient.selectedLanguage);
...
Widget totalCount({String? title, String? subTitle, String? description,bool? isTotal=false}) {
  return Row(
    ...
    children: [
      ...
      Text(appStoreClient.currencyPosition == LEFT ? '${appStoreClient.currencyCode} $subTitle' : '$subTitle ${appStoreClient.currencyCode}', style: isTotal==true?boldTextStyle():primaryTextStyle()),
    ],
  );
}
