...
Color borderColor = Color(0xFF00346f);
Color   primaryColorD= Color(0xFF00340b);

const scaffoldSecondaryDark = Color(0xFF00340b);
const scaffoldColorDark = Color(0xFF00340b);
const scaffoldColorLight = Colors.white;
const appButtonColorDark = Color(0xFF00340b);
