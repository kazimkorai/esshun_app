...
class LocationPermissionScreenState extends State<LocationPermissionScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: borderColor,automaticallyImplyLeading: false),
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 32),
              Text(language.mostReliableeshhunDriverApp, style: boldTextStyle(size: 18)),
              SizedBox(height: 16),
              Text(language.toEnjoyYourRideExperiencePleaseAllowPermissions, style: secondaryTextStyle(color: primaryColorD), textAlign: TextAlign.center),
              SizedBox(height: 32),
              AppButtonWidget(
