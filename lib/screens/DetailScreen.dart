                            ...
                            if (riderModel!.couponData != null && riderModel!.couponDiscount != 0)
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                      appStoreClient.currencyPosition == LEFT
                                          ? '-${appStoreClient.currencyCode} ${riderModel!.couponDiscount.toString()}'
                                          : '-${riderModel!.couponDiscount.toString()} ${appStoreClient.currencyCode}',
