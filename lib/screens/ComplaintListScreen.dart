      ...
      body: Observer(builder: (context) {
        return Stack(
          children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  ], color: complaintListData[index].addedBy != ADMIN ? primaryColorD : Theme.of(context).cardColor, borderRadius: BorderRadius.circular(16)),
                                  child: Text(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    inkWellWidget(
                      child: Icon(Icons.send, color: primaryColorD, size: 25),
                      onTap: () {
            ...
            if (appStoreClient.isLoading) loaderWidget(),
            if (!appStoreClient.isLoading && complaintListData.isEmpty) emptyWidget()
          ],
        );
      }),
    );
