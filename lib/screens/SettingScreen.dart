            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  leading: Icon(Icons.offline_bolt_outlined, size: 25, color: primaryColorD),
                  ...
                  onTap: () async {
                    if (appStoreClient.currentRiderRequest == null) {
  ...
  Widget settingItemWidget(IconData icon, String title, Function() onTap, {bool isLast = false, IconData? suffixIcon}) {
    return Column(
      ...
      children: [
        ListTile(
          contentPadding: EdgeInsets.only(left: 16, right: 16),
          leading: Icon(icon, size: 25, color: primaryColorD),
