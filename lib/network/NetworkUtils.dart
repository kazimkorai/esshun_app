...
Map<String, String> buildHeaderTokens() {
  ...
  if (appStoreClient.isLoggedIn) {
    header.putIfAbsent(HttpHeaders.authorizationHeader, () => 'Bearer ${sharedPref.getString(TOKEN).toString()}');
  }
...
Uri buildBaseUrl(String endPoint) {
  ...
  if (!endPoint.startsWith('https')) url = Uri.parse('$mBaseUrl$endPoint');
