            ...
            child: Column(
              ...
              children: [
                ...
                buildText(
                  ...
                  value:
                      appStoreClient.currencyPosition == LEFT ? '${appStoreClient.currencyCode} ${Utils.formatPrice(invoice.totalAmount)}' : '${Utils.formatPrice(invoice.totalAmount)} ${appStoreClient.currencyCode} ',
                  unite: true,
                ),
              ],
            ),
