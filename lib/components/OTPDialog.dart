    ...
    await FirebaseAuth.instance.signInWithCredential(credential).then((result) async {
      ...
      await logInApi(req, isSocialLogin: true).then((value) async {
        ...
        if (value.data == null) {
          ...
          launchScreen(context, DriverRegisterScreen(countryCode: otpCode, socialLogin: true));
        } else {
                  ...
                  children: [
                    CountryCodePicker(
                      ...
                      searchDecoration: InputDecoration(
                        ...
                        focusedBorder: UnderlineInputBorder(borderSide: BorderSide(color: primaryColorD)),
                      ),
      ...
      return Stack(
        children: [
          Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              Icon(Icons.message, color: primaryColorD, size: 50),
              SizedBox(height: 16),
