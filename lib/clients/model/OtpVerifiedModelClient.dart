...
OtpVerifiedModel otpVerifiedModelFromJson(String str) => OtpVerifiedModel.fromJson(json.decode(str));

String otpVerifiedModelToJson(OtpVerifiedModel data) => json.encode(data.toJson());
