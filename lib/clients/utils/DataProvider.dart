...
List<ChatMessageModelClient> getChatList() {
  List<ChatMessageModelClient> list = [];
  list.add(ChatMessageModelClient(message: 'Hellokjkljkljkljkljkl;jk;lk;k;lk;lk;k;k;k;lk;k;l', isMessageRead: true));
  list.add(ChatMessageModelClient(message: 'Hellokjklj', isMessageRead: false));
  list.add(ChatMessageModelClient(message: 'Hellokjkljkljkljkljkl;', isMessageRead: true));
  list.add(ChatMessageModelClient(message: 'Hellokjkljkljkljkljkl;jk;lk;k;lk;lk;k;k;k;lk;k;l', isMessageRead: false));
  list.add(ChatMessageModelClient(message: 'Hellokjklj', isMessageRead: true));
  list.add(ChatMessageModelClient(message: 'Hellokjkljkljkljkljkl;', isMessageRead: false));
  list.add(ChatMessageModelClient(message: 'Hellokjkljkljkljkljkl;jk;lk;k;lk;lk;k;k;k;lk;k;l', isMessageRead: true));
  list.add(ChatMessageModelClient(message: 'Hellokjklj', isMessageRead: false));
  list.add(ChatMessageModelClient(message: 'Hellokjkljkljkljkljkl;', isMessageRead: true));
  list.add(ChatMessageModelClient(message: 'Hellokjkljkljkljkljkl;jk;lk;k;lk;lk;k;k;k;lk;k;l', isMessageRead: false));
