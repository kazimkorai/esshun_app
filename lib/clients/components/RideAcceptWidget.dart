...
class RideAcceptWidgetState extends State<RideAcceptWidget> {
  ...
  void init() async {
    await getUserDetailClient(userId: widget.rideRequest!.driverId).then((value) {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              inkWellWidget(
                onTap: () {
                  launchScreen(context, ChatScreenClient(userData: userData), pageRouteAnimation: PageRouteAnimation.SlideBottomTop);
                },
                child: Container(
