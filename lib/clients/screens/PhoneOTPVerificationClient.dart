...
import 'package:taxi_driver/clients/utils/Extensions/app_common.dart';
import 'package:taxi_driver/screens/DriverRegisterScreen.dart';
import 'package:taxi_driver/utils/Colors.dart';

class OTPVerificationPageClient extends StatefulWidget {
  String phoneNo;

  OTPVerificationPageClient(this.phoneNo);
  @override
  _OTPVerificationPageClientState createState() => _OTPVerificationPageClientState();
}

class _OTPVerificationPageClientState extends State<OTPVerificationPageClient> {
...
class OtpRegisterClient extends StatefulWidget {

  @override
  _OtpRegisterClientState createState() => _OtpRegisterClientState();
}

class _OtpRegisterClientState extends State<OtpRegisterClient> {
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        if(txtPhoneNo.value.text.length==8){
                          ...
                          loginWithOtp(mapData,context,false);
                        }
                        else{
