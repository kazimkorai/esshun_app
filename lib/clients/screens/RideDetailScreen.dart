...
import 'package:taxi_driver/clients/model/DriverRatting.dart';
...
class RideDetailScreenState extends State<RideDetailScreen> {
  ...
  DriverRattingClient? driverRatting;
  ComplaintModelClient? complaintData;
  Payment? payment;
  UserData? userData;
  ...
  void init() async {
    ...
    await rideDetail(orderId: widget.orderId).then((value) {
      ...
      driverRatting = value.driverRatting! as DriverRattingClient?;
    ...
    return Scaffold(
        ...
        actions: [
          IconButton(
              onPressed: () {
                launchScreen(
                  context,
                  ComplaintScreenClient(
                    driverRatting: driverRatting ?? DriverRattingClient(),
      ...
      body: Stack(
        children: [
            ...
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    decoration: BoxDecoration(
                      color: appStoreClient.isDarkMode ? scaffoldSecondaryDark : primaryColor.withOpacity(0.05),
                      borderRadius: radius(),
                    ),
                    padding: EdgeInsets.all(16),
                    child: Column(
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(color: appStoreClient.isDarkMode ? scaffoldSecondaryDark : primaryColor.withOpacity(0.05), borderRadius: radius()),
                          padding: EdgeInsets.all(16),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
          ...
          if (!appStoreClient.isLoading && riderModel == null) emptyWidget(),
