...
class EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void init() async {
    ...
    getUserDetailClient(
            userId: int.parse(sharedPref.getString(USER_ID).toString()))
        .then((value) {
      ...
      selectGender = value.data!.gender.toString() == 'null'
          ? MALE
  ...
  Future<void> saveProfile() async {
    String userId= await sharedPref.getString(USER_ID).toString();
    if(userId!='null'){
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    value: selectGender,
                    // Ensure this matches one of the values in items
                    onChanged: (String? newValue) {
                      setState(() {
                        selectGender = newValue.toString();
                      });
                    },
      ...
      bottomNavigationBar: Padding(
        padding: EdgeInsets.only(bottom: 22,left: 14,right: 14),
