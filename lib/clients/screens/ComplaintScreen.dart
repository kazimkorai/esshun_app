...
import 'package:taxi_driver/clients/model/ComplaintModel.dart';
...
class ComplaintScreenClient extends StatefulWidget {
  final DriverRattingClient driverRatting;
  final RiderModel? riderModel;
  final ComplaintModelClient? complaintModel;

  ComplaintScreenClient({required this.driverRatting, this.complaintModel, this.riderModel});

  @override
  ComplaintScreenClientState createState() => ComplaintScreenClientState();
}

class ComplaintScreenClientState extends State<ComplaintScreenClient> {
