...
class ChatItemWidget extends StatefulWidget {
  final ChatMessageModelClient? data;
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onLongPress: !widget.data!.isMe!
          ? null
          : () async {
              bool? res = await showConfirmDialogCustom(context, positiveText: language.yes, negativeText: language.no, primaryColor: primaryColorD, onAccept: (BuildContext context) {});
              if (res ?? false) {
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                boxShadow: appStoreClient.isDarkMode ? null : defaultBoxShadow(),
                color: widget.data!.isMe.validate() ? primaryColorD : scaffoldColorLight,
